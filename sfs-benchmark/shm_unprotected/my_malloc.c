/**
 * A proof-of-concept malloc implementation allocating memory blocks in a private
 * __unprotected__ memory buffer.
 *
 * TODO replace this crappy implementation with a real one...
 *
 */
...
struct FREE_CHUNK *free_list_head;
